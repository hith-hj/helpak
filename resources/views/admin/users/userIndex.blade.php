                    ...
                    <table class="table table-hover" id="grid-table5e7cd3e221e49">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="column-username">{{$user->name}}</td>
                                <td class="column-name">{{$user->firstName}}</td>
                                <td class="column-name">{{$user->lastName}}</td>
                                <td class="column-name">{{$user->age}}</td>
                                <td class="column-name">{{$user->gender}}</td>
                                <td class="column-name">{{$user->image}}</td>
                                <td class="column-name">
                                    <span class="label label-success">{{$user->content}}</span>
                                </td>
                                ...
                                <td class="column-__actions__">
                                    <div class="grid-dropdown-actions dropdown" style="z-index:100;">
                                        <a href="/admin/userShow/{{$user->id}}" style="padding:0 5px">
                                        <i class="fa fa-eye"></i>
                                        </a>
